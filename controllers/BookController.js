...
const getBook = (req, res) => {
    ...
    pool.getConnection((err, connection) => {
        ...
        connection.query(query, (err, results) => {
            ...
            responseSuccess(res, results, 'Book succesfully fatched')
        })
        connection.release()
    })
}
...
const updateBook = (req, res) => {
    ...
    pool.getConnection((err, connection) =>  {
        ...
        connection.query(query, [data], (err, results) => {
            ...
            responseSuccess(res, results, 'Books succesfully updated')
        }) 
...
const deleteBook = (req,res) => {
    ...
    pool.getConnection((err, connection) => {
        ...
        connection.query(query, (err, results) => {
            ...
            responseSuccess(res, results, 'Book succesfully deteleted')
        })
